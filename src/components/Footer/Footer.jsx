  ...
  return (
    <div className="footer" id="footer">
      <div className="box-container">
        <div className="box">
          <h3>
          Urban Footwear <i className="fa-solid fa-shoe-prints
"></i>
          </h3>
          <p>
        ...
        <div className="box">
          ...
          <a href="#" className="links">
            {" "}
            <i className="fas fa-phone"></i>071-5644000{" "}
          </a>
          <a href="#" className="links">
            {" "}
            <i className="fas fa-phone"></i>071-5644005{" "}
          </a>
          <a href="#" className="links">
            {" "}
            <i className="fas fa-envelope"></i>  info@iba-suk.edu.pk{" "}
          </a>
          <a href="#" className="links">
            {" "}
    ...
    <div className="credit">
        created by <span>Goutam</span> | all rights reserved
    </div>
    </div>
  );
}
